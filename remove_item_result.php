<?php
    ...
    if (isset($_SESSION["deleted_item"])) {
        $deleted = $_SESSION["deleted_item"];
        $message = "<p>Successfully deleted item <b>" . $deleted . "</b></p>";
        unset($_SESSION["deleted_item"]);
    } else {
        if (isset($_SESSION["failed_item"])) {
            $failed = $_SESSION["failed_item"];
            $message = "<p>Couldn't delete item <b>" . $failed . "</b></p>";
